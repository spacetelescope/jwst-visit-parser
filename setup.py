...
PACKAGENAME = metadata.get('package_name', 'visitparser')
DESCRIPTION = metadata.get('description', 'Tools for parsing information from JWST visit files.')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: visitparser requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
